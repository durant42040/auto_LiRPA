...
_JIT_ATEN_MAP = {
    ...
    "aten::view": "BoundReshape",
    "aten::reshape": "BoundReshape",
    "aten::expand": "BoundExpand",
    "aten::sub": "BoundAtenJitSub",
    "aten::remainder": "BoundAtenJitRemainder",
    "aten::fft_fftshift": "BoundFftShift",
    "aten::repeat": "BoundTile",
    "aten::add": "BoundAdd",
    "aten::mul": "BoundMul",
    "aten::cat": "BoundAtenJitCat",
    "aten::relu": "BoundRelu",
    "aten::gelu": "BoundAtenJitGelu",
    "aten::_convolution": "BoundAtenJitConvolution",
